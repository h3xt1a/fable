...
$(function() {
  ...
  if(bgndKenburns.length){
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "img/backgrounds/1.webp" },
        { src: "img/backgrounds/2.webp" },
        { src: "img/backgrounds/3.webp" },
        { src: "img/backgrounds/4.webp" },
        { src: "img/backgrounds/5.webp" },
        { src: "img/backgrounds/6.webp" },
        { src: "img/backgrounds/7.webp" }
      ],
